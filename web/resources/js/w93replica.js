...
const apps = {
    pointChecker1: {
        name: 'Лаба №1',
        icoImgUrl: './resources/img/cat.png',
        url: 'http://p-n-p.herokuapp.com/l1/'
    },
    pointChecker5: {
        name: 'Лаба №2',
        icoImgUrl: './resources/img/afanas.png',
        url: 'http://localhost:22080/lab_2/'
    },
    pointChecker2: {
        name: 'Лаба №3',
        icoImgUrl: './resources/img/dak.png',
        url: 'http://localhost:22080/Lab3/view/index.xhtml'
    }
};
